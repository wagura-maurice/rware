                  ...
                  <table class="min-w-full overflow-x-scroll divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap"><a href="#"># {!! $data->id !!}</a></td>
                          ...
                          <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap"><a href="#">{!! $data->email !!}</a></td>
                          <td class="px-6 py-4 whitespace-nowrap">
                            <span
                          ...
                          @can('user_management_access')
                            <!-- <a href="{!! route('users.edit', $data->id) !!}"><span class="inline-flex items-center justify-center h-5 w-12 text-lg text-gray-600"><i class="bx bx-edit"></i></span></a>                 -->
                            <a href="{!! route('users.destroy', $data->id) !!}" onclick="event.preventDefault(); document.getElementById('users-destroy-{!! $data->id !!}').submit();"><span class="inline-flex items-center justify-center h-5 w-12 text-lg text-gray-600"><i class="bx bx-trash"></i></span></a>
                            <form id="users-destroy-{!! $data->id !!}" action="{!! route('users.destroy', $data->id) !!}" method="POST" style="display: none;">
                                @method('DELETE')
                                @csrf
                            </form>
                          @endcan
