...
<x-slot name="breadcrumb">
        ...
        <div
          ...
          >
            <h1 class="text-2xl font-semibold whitespace-nowrap">{!! $businesses->template->title !!}</h1>
            <div class="space-x-2">
            <a
              href="{!! $businesses->template->url->{1} !!}"
            ...
            > <!-- animate-bounce -->
              ...
              <span>{!! $businesses->template->url->{0} !!}</span>
            </a>
            </div>
          </div>
    </x-slot>
