                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap"><a href="#"># {!! $data->id !!}</a></td>
                          ...
                          <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">
                            <a href="{!! route('applications.index', $data->id) !!}" target="_blank"><span class="inline-flex items-center justify-center h-5 w-12 text-lg text-gray-600"><i class="bx bx-share"></i></span></a>
                          @can('certification_categories_create')                     
