...
<x-slot name="breadcrumb">
        ...
        <div
          ...
          >
            <h1 class="text-2xl font-semibold whitespace-nowrap">{!! $categories->template->title !!}</h1>
            @can('certification_categories_create')
              <div class="space-x-2">
              <a
                href="{!! $categories->template->url->{1} !!}"
              ...
              > <!-- animate-bounce -->
                ...
                <span>{!! $categories->template->url->{0} !!}</span>
              </a>
              </div>
            @endcan
          </div>
          ...
          <div class="px-4 py-5 bg-white sm:p-6">
            <div class="grid grid-cols-6 gap-6">
              ...
              <div class="col-span-6 sm:col-span-3">
                ...
                <select id="certification_type" name="certification_type_id" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
              ...
              <div class="col-span-6 sm:col-span-3">
                <label for="price" class="block text-sm font-medium text-gray-700">Price <small>(Sq Ft)</small></label>
              ...
              <p class="mt-2 text-sm text-gray-500">
                Brief description for your certification category.
              </p>
            </div>
